...
public class HospitalApiController {
    ...
    @PostMapping("/unregister/{hospitalId}")
    public Api<MessageResponse> unregister(@PathVariable Long hospitalId, @UserSession User user) {
        MessageResponse response = hospitalBusiness.unregister(hospitalId, user.getId());
        return Api.OK(response);
    }
